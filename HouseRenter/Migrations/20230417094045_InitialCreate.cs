...
namespace HouseRenter.Migrations
{
    /// <inheritdoc />
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HouseAds", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HouseAds_Broker_BrokerId",
                        column: x => x.BrokerId,
                        principalTable: "Broker",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HouseAds_Category_CategoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HouseAds_BrokerId",
                table: "HouseAds",
                column: "BrokerId");

            migrationBuilder.CreateIndex(
                name: "IX_HouseAds_CategoryId",
                table: "HouseAds",
                column: "CategoryId");
        }
